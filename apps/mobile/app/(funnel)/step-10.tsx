/**
 * Funnel Step 10 — referral_gate (KR variant: exactly 1 referral required)
 *
 ...
 * FUNNEL_SCREENS.referral_gate (variantTag: 'kr_variant').
 */
import { View, Text, StyleSheet } from 'react-native';

export default function FunnelStep10Screen(): JSX.Element {
  return (
    <View style={styles.container}>
      <Text style={styles.title}>Funnel Step 10</Text>
