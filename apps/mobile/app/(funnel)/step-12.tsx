/**
 * Funnel Step 12 — payment_model (KR variant: $12/mo or $59/yr + 37-day trial)
 *
 ...
 * FUNNEL_SCREENS.payment_model (variantTag: 'kr_variant').
 */
import { View, Text, StyleSheet } from 'react-native';

export default function FunnelStep12Screen(): JSX.Element {
  return (
    <View style={styles.container}>
      <Text style={styles.title}>Funnel Step 12</Text>
