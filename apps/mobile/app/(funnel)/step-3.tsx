/**
 * Funnel Step 3 — social_proof_intro
 *
 ...
 * FUNNEL_SCREENS.social_proof_intro.
 */
import { View, Text, StyleSheet } from 'react-native';

export default function FunnelStep3Screen(): JSX.Element {
  return (
    <View style={styles.container}>
      <Text style={styles.title}>Funnel Step 3</Text>
      <Text style={styles.subtitle}>social_proof_intro</Text>
    </View>
  );
}
